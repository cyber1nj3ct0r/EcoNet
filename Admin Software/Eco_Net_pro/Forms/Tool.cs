...
namespace Eco_Net_pro
{
    public partial class Tool : UserControl
    {
        ...
        {
            Eco_Community Eco_CommunityPage = new Eco_Community();
            Tool tool = new Tool();
            Eco_CommunityPage.Dock = DockStyle.Fill;
            Parent.Controls.Add(Eco_CommunityPage);
            Parent.Controls.Remove(tool);
            Eco_CommunityPage.BringToFront();
        }
    }
}
